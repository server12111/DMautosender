...
PRIVACY_TEXT = """
📄 <b>Политика конфиденциальности AutoSender DM</b>
...
TERMS_TEXT = """
📋 <b>Пользовательское соглашение AutoSender DM</b>

<b>Последнее обновление: 01.06.2025</b>

<b>1. Предмет соглашения</b>
AutoSender DM предоставляет инструмент для автоматической отправки сообщений в Telegram через пользовательские аккаунты.
...
def _welcome_text(user: BotUser) -> str:
    ...
    return (
        f"{e('👋')} Привет, <b>{name}</b>!\n\n"
        f"{e('🤖')} <b>AutoSender DM</b> — мощный инструмент для автоматической\n"
...
def _main_menu_text(user: BotUser) -> str:
    return (
        f"{e('👋')} Добро пожаловать в <b>AutoSender DM</b>!\n\n"
